...
namespace BlazorWindowManager.RazorClassLibrary.Dimensions;
...
public class ViewportDimensionsService : IViewportDimensionsService
{
    ...
    {
        return await _jsRuntime.InvokeAsync<ViewportDimensionsModel>("blazorWindowManager.getViewportDimensions");
    }
}
